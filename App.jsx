...
function CartScreen({ cart, updateQty, removeItem, go, back }) {
  ...
  return (
    <div style={{ paddingBottom: cart.length ? 150 : 20 }}>
      ...
      {cart.length > 0 && (
        <div style={{ position: "fixed", bottom: 60, left: 0, right: 0, maxWidth: 430, margin: "0 auto", background: "#fff", borderTop: `1px solid ${C.line}`, padding: 14, boxShadow: "0 -2px 10px rgba(0,0,0,0.04)" }}>
